...
public class EnemyFactory {
    ...
    public static Enemy createRandomEnemy(Area area, int playerLevel) {
        if (area.getName().equalsIgnoreCase("Lemon Fields")) {
            return createLemonFieldsEnemy(playerLevel);
        }
    ...
    private static Enemy createLemonFieldsEnemy(int playerLevel) {
        ...
        switch (option) {
            ...
            case 3:
                return createScaledEnemy("Lemon-man", 66, 33, 33, 999, 9999, playerLevel);
